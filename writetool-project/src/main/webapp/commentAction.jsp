...
<jsp:useBean id="comment" class="ccomment.Comment" scope="page" />
<jsp:setProperty name="comment" property="freeID"/>
<jsp:setProperty name="comment" property="number"/>
<jsp:setProperty name="comment" property="commentText"/>
<jsp:setProperty name="comment" property="commentDate" />
...
<body>
	...
	String userID = null;
		...
		int result = commentDAO.commentwrite(comment.getFreeID(),comment.getNumber(),userID,comment.getCommentText());
		...
		if (result == -1) {
			...
			script.println("location.href = 'view3.jsp?freeID="+freeID+"&roundID="+roundID+"&number="+number+"'");
			script.println("</script>");
