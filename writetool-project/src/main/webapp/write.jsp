...
<%
	...
	<form method="post" id="frm" accept-charset="utf-8" action="writestoryAction.jsp?freeID=<%=freeID%>">
	<nav class="titlenav">
		<span class="titlespan"><%=free.getfTitle() %></span>
		<span class="inputspan"><span class="roundspan">화</span><input type="text" class="roundbox" name="roundID"></span>
		<hr class="navhr">
	</nav>
