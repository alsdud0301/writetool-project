...
// 		}
	...
	roundID = Integer.parseInt(request.getParameter("roundID"));
		...
		freecontent freetest = new freecontentshowDAO().getfreecontent(freeID,number);
...
<header class = "menubar">
	...
	<nav class="titlenav">
		...
		<span class="hit"><i class="fa-solid fa-eye"></i><%=freetest.getHit()+ 1%></span>
 ...
 --%>
	...
	<div class="summarydiv">
		...
		<div class="summarydiv2" style ="overflow:auto;"><%=freetest.getSummary()%></div>
	</div>
	<div class="storydiv"><%=freetest.getStory() %></div>
	<div class="btn">
	...
	<form method="post" action ="commentAction.jsp?freeID=<%=free.getFreeID()%>&roundID=<%=freetest.getRoundID() %>&number=<%=freetest.getNumber()%>">
